<script>
  import ProductOverviewWithGridBreadcrumb from "./ProductOverviewWithGridBreadcrumb.svelte";
  import ProductOverviewWithGridImageGallery from "./ProductOverviewWithGridImageGallery.svelte";
...
<div class="bg-white">
  <div class="pt-6">
    ...
    {:then product}
      <ProductOverviewWithGridBreadcrumb breadcrumbs={product.breadcrumbs} />
      <ProductOverviewWithGridImageGallery images={product.images} />
      <!-- Product info -->
      <div
    ...
    {:catch error}
      <div class="h-full flex justify-center items-center">
        <p class="mx-auto text-red-500">{error.message}</p>
      </div>
    {/await}
  </div>
</div>
